...
public class AllStudentShow extends javax.swing.JFrame {
   ...
   public static DashBoard db;
    ...
    public AllStudentShow() {
        ...
        SemmesterField.setText(StudentLogin.sec);
    }
    ...
    private void initComponents() {
        ...
        Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "FatherName", "MotherName", "Dept", "Age", "BirthDate", "BloodGroup", "Gender", "Class", "Section", "Email", "Contact", "GurdianContact", "Address", "GPA"
            }
        ));
    ...
    private void ShowTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ShowTableActionPerformed
        try{ 
            ...
            section=SemmesterField.getText();
            ...
            while(rs.next())
            {
                ...
                rowdata[12]=rs.getString("ContactNo");
                rowdata[13]=rs.getString("GurdianContact");
