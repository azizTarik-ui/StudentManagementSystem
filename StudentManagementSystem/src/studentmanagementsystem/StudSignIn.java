    ...
    private void CreateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateButtonActionPerformed
        ...
        else
        {
            try {
                ...
                pst=(PreparedStatement) con.prepareStatement("insert into userlog(id,name,email,password,Dept,Class,Section,Designation,Shift)values(?,?,?,?,?,?,?,?,?)");
                pst.setInt(1, id);
                ...
                pst2=(PreparedStatement) con.prepareStatement("INSERT INTO attendencerecord(Dept, Shift, Class, Section, Date, Present, Absent) VALUES (?,?,?,?,?,?,?)");
                pst2.setString(1, dept);
                pst2.setString(2, shift);
                pst2.setInt(3, clas);
                pst2.setString(4, sec);
