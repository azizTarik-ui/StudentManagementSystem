...
public class ParsonalInformationShow extends javax.swing.JFrame {
    ...
    public ParsonalInformationShow()  {
        ...
        try {
            ...
            pst1=(PreparedStatement) con.prepareStatement("select * from userinfo where id=? and Dept=? and Class=? and Semester=? and Shift=?");
            pst1.setInt(1, id);
            pst1.setString(2, dpt);
            pst1.setInt(3, StudentLogin.clas);
            pst1.setString(4, StudentLogin.sec);
            pst1.setString(5, StudentLogin.shift);
