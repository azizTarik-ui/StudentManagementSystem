...
public class Attendence extends javax.swing.JFrame {
    ...
    public Attendence() {
        ...
        //totalstud=DashBoard.totalStudinSec;
    ...
    void showWorkDay()
    {
        try {
            ...
            pst3=(PreparedStatement) con.prepareStatement("SELECT * FROM parfoemance WHERE Class=? and Section=? and Dept=? and Shift=?");
            pst3.setInt(1, Integer.parseInt(classField.getText()));
            pst3.setString(2, Sec.getText());
            pst3.setString(3, dept);
            pst3.setString(4, StudentLogin.shift);
            
            rs2=pst3.executeQuery();
            
            if(rs2.next())
            {
                TotalWorkDay=rs2.getInt("TotalWorkDays");
            }
            totalWork.setText(Integer.toString(TotalWorkDay));
    ...
    private void initComponents() {
        ...
        totalWork = new javax.swing.JTextField();
        ...
        jLabel4.setText("Total Work days:");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(totalWork, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabel4)
                        .addComponent(totalWork, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void TAttendanceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TAttendanceActionPerformed
        ...
        try{
                ...
                for(int row=0;row<model.getRowCount();row++)
                {
                    ...
                    else
                    {
                        if(state1.equals("true"))
                        {
                            ...
                            pst=(PreparedStatement) con.prepareStatement("SELECT * FROM parfoemance WHERE id=? and Class=? and Dept=? and Section=? and Shift=?");
                            ...
                            pst.setString(5, StudentLogin.shift);
                            rs=pst.executeQuery();
                        ...
                        pst3=(PreparedStatement) con.prepareStatement("UPDATE parfoemance SET TotalWorkDays=? WHERE Dept=? and Shift=? and Class=? and Section=?");
                        pst3.setInt(1, Integer.parseInt(totalWork.getText()));
                        pst3.setString(2, StudentLogin.dept);
                        pst3.setString(3, StudentLogin.shift);
                        pst3.setInt(4, Integer.parseInt(classField.getText()));
                        pst3.setString(5, Sec.getText());
                        pst3.executeUpdate();
                        
                        pst5=(PreparedStatement) con.prepareStatement("UPDATE attendencerecord SET Date=?,Present=?,Absent=? WHERE Dept=? and Shift=? and Class=? and Section=?");
                        pst5.setString(1, date);
                        pst5.setInt(2, pres);
                        pst5.setInt(3, absen);
                        pst5.setString(4, StudentLogin.dept);
                        pst5.setString(5, StudentLogin.shift);
                        pst5.setInt(6, StudentLogin.clas);
                        pst5.setString(7, StudentLogin.sec);
                        pst5.executeUpdate();
            ...
            System.out.println("Total Present:"+pres+"  Total Absent:"+absen);
        }
        catch(ClassNotFoundException ex)
        {
    ...
    private javax.swing.JTextField totalWork;
